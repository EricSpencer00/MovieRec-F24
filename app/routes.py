...
import model
from model.content_based_model import (
    load_data,
    preprocess_data,
    create_tfidf_matrix,
...
def init_routes(app):
    ...
    def movie(movie_id):
        try:
            ...
            recommendations = get_recommendations(movie_data["movie_title"], movies, cosine_sim)
            
            return render_template("movie_info.html", movie=movie_data, recommendations=recommendations)
    ...
    def discover():
        ...
        if request.method == "POST":
            ...
            try:
                ...
                recommendation_dicts = model.run_colab_model.get_recommendations(
